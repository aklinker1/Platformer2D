...
public class Physics {
    ...
    public static class Player {
        ...
        public static final float JUMP_SPEED = 0.34f; // allows for a min jump height of 3 blocks
        public static final float JUMP_SPEED_RUN = 0.400f; // allows for a max jump height of 5 blocks

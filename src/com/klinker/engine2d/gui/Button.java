...
public class Button extends TextView {
    ...
    public Button(String text, Size<Float> size, Vector3f position, String fontDir) {
        ...
        background.put(State.DEFAULT, new SimpleSprite(this.position, size, R.textures.tiles.T01_01));
        background.put(State.SELECTED, new SimpleSprite(this.position, size, R.textures.tiles.T01_02));
    }
